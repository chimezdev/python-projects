...
# He wants everyone who run his program to play the Guess the secret number game, and guess 
# what number he has picked for them. Those who don't guess the number will be stuck in an endless 
# loop forever! Unfortunately, he does not know how to complete the code.
...
+================================+
""") #this is known as 'multi-line printing

guess_num = int(input("Enter the secret number! "))
    
while guess_num != secret_number:
    print("Ha ha! You're stuck in my loop!")
    guess_num = int(input("Enter the secret number again! "))

print("Well done, muggle! You are free now.")
print("You guessed right. The Secret number is ", guess_num)
